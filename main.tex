...
\hline Filter cuts & Filter eff. & Bias\footnote{Fraction of events passing offline cuts but rejected by gen filter}  ($N_J^{rec}=7$)&  ($N_J^{rec}>=8$) & ($N_J^{rec}=9$)&  ($N_J^{rec}>=10$)& Sample ($\times 10$) \\ 
\hline \thead{HT$>$500 \\ \&\& nJets+nLep$>$=8 \\ \&\& $>1$ lepton} & $0.020 \pm 0.0004$  & --- & --- & --- & --- & 87.3 M\\ 
\hline \thead{HT$>$500 \\ \&\& nJets+nLep$>$=9 \\ \&\& $>1$ lepton} & $0.008 \pm 0.0002$   & --- & --- & 0.19 & 0.1 & 35M\\ 
\hline \thead{HT$>$500 \\ \&\& nJets+nLep$>$=10 \\ \&\& $>1$ lepton} & $0.003 \pm 6.5\times 10^{-4}$   & --- & --- & 0.44 & 0.19 & 13M\\
\hline 
\end{tabular} }
\end{center}
\end{frame}
